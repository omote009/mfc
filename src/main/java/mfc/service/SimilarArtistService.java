    ...
    public final List<String> getListSimilarArtist(final String artistCode,final int limit){
        ...
        if(specifiedArtist != null){
            ...
            for(String artistCodeKey : containXandYcodeMap.keySet()) {
                ...
                artistCodeListForSortWork.add(String.format("%010d", containXandYcodeMap.get(artistCodeKey).intValue()) + String.format("%010d", tmp)+ "_" + artistCodeKey);
            }
            ...
            randomGen2.setSeed(Integer.valueOf((int)(System.currentTimeMillis() % artistMrList.size()-1)).intValue());
