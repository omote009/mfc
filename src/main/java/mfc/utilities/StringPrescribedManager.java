...
public class StringPrescribedManager {
    ...
    public static String convert(final String inputedString) {
        ...
        StringBuilder returnStringBuilder =
            new StringBuilder(hanToZenKanaStr(inputedString));
    ...
    public static String hanToZenKanaStr(String hanKanaString) {
        ...
        if (hanKanaString.length() == 0) {
            ...
            for (i = 0; i < result.length() - 1; i++) {
                ...
                char margedChar =
                    hanToZenKanaMergeChar(originalChar1, originalChar2);
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String zenToHanKanaStr(String zenKanaStr) {
        if (zenKanaStr == null) {
            return "";
        }
        if (zenKanaStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder();
        for (int i = 0; i < zenKanaStr.length(); i++) {
            char originalChar = zenKanaStr.charAt(i);
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String hiraKanaToZenKanaStr(String zenHiraganaStr) {
        if (zenHiraganaStr == null) {
            return "";
        }
        if (zenHiraganaStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder(zenHiraganaStr);
        for (int i = 0; i < result.length(); i++) {
            char c = result.charAt(i);
            if (c >= 'ぁ' && c <= 'ん') {
                result.setCharAt(i, (char) (c - 'ぁ' + 'ァ'));
            }
        }
        return result.toString();
    }
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String zenKanaToHiraKanaStr(String zenKanaStr) {
        if (zenKanaStr == null) {
            return "";
        }
        if (zenKanaStr.isEmpty()) {
        ...
        StringBuilder result = new StringBuilder(zenKanaStr);
        for (int i = 0; i < result.length(); i++) {
            char c = result.charAt(i);
            if (c >= 'ァ' && c <= 'ン') {
                result.setCharAt(i, (char) (c - 'ァ' + 'ぁ'));
            } else if (c == 'ヵ') {
                result.setCharAt(i, 'か');
            } else if (c == 'ヶ') {
                result.setCharAt(i, 'け');
            } else if (c == 'ヴ') {
                result.setCharAt(i, 'う');
                result.insert(i + 1, '゛');
                i++;
            }
        }
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String zenAlphaToHanStr(String zenAlphaStr) {
        if (zenAlphaStr == null) {
            return "";
        }
        if (zenAlphaStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder(zenAlphaStr);
        for (int i = 0; i < result.length(); i++) {
            char c = result.charAt(i);
            if (c >= 'ａ' && c <= 'ｚ') {
                result.setCharAt(i, (char) (c - 'ａ' + 'a'));
            } else if (c >= 'Ａ' && c <= 'Ｚ') {
                result.setCharAt(i, (char) (c - 'Ａ' + 'A'));
            }
        }
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String hanAlphaToZenStr(String hanAlphaStr) {
        if (hanAlphaStr == null) {
            return "";
        }
        if (hanAlphaStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder(hanAlphaStr);
        for (int i = 0; i < hanAlphaStr.length(); i++) {
            char c = hanAlphaStr.charAt(i);
            if (c >= 'a' && c <= 'z') {
                result.setCharAt(i, (char) (c - 'a' + 'ａ'));
            } else if (c >= 'A' && c <= 'Z') {
                result.setCharAt(i, (char) (c - 'A' + 'Ａ'));
            }
        }
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String hanNumToZenStr(String hanNumStr) {
        if (hanNumStr == null) {
            return "";
        }
        if (hanNumStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder(hanNumStr);
        for (int i = 0; i < hanNumStr.length(); i++) {
            char c = hanNumStr.charAt(i);
            if (c >= '0' && c <= '9') {
                result.setCharAt(i, (char) (c - '0' + '０'));
            }
        }
        return result.toString();
    }
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    public static String zenNumToHanStr(String zenNumStr) {
        if (zenNumStr == null) {
            return "";
        }
        if (zenNumStr.isEmpty()) {
            return "";
        }
        StringBuilder result = new StringBuilder(zenNumStr);
        for (int i = 0; i < result.length(); i++) {
            char c = result.charAt(i);
            if (c >= '０' && c <= '９') {
                result.setCharAt(i, (char) (c - '０' + '0'));
            }
        }
        return result.toString();
    }
*/
     ...
     * 変換用半角カナテーブル。<br>
     */
    private static final char[] HAN_KANA_TBL = {
        '｡',
        '｢',
        '｣',
        '､',
     ...
     * 変換用全角カナテーブル。<br>
     */
    private static final char[] ZEN_AKANA_TBL = {
        '。',
        '「',
        '」',
        '、',
     ...
     */
    private static final char HAN_KANA_LAST_CHAR =
        HAN_KANA_TBL[HAN_KANA_TBL.length - 1];
     ...
     * 全角カタカナ。<br>
     *//*
    private static final char[] ZEN_KANA_A = {
        'ァ',
        'ア',
        'ィ',
        'イ',
    ...
    *//**
     ...
     * 半角カタカナ。<br>
     *//*
    private static final String[] HANK_KANA_A = {
        "ｧ",
        "ｱ",
        "ｨ",
        "ｲ",
    ...
    *//**
     ...
     * @return 変換後文字列
     *//*
    protected static String zenToHankanaChar(char zenKanaChar) {
        if (zenKanaChar >= ZEN_KANA_FIRST_CHAR_A
            && zenKanaChar <= ZEN_KANA_LAST_CHAR_A) {
            return HANK_KANA_A[zenKanaChar - ZEN_KANA_FIRST_CHAR_A];
        } else {
            return String.valueOf(zenKanaChar);
        }
    }
